...
knex.schema
  .createTableIfNotExists("user", (table) => {
    ...
    table
      .string("perfil")
      .defaultTo(
        `http://localhost:${process.env.PORT}/profileImgs/defaultProfileImage.jpg`
      );
    table.boolean("admin");
    ...
    knex.schema
      .createTableIfNotExists("productos", (table) => {
        ...
        table
          .string("fotoProd")
          .defaultTo(
            "http://localhost:${process.env.PORT}/profileImgs/defaultImage.png"
          );
